...
onMounted(() => {
  pageTitle.value = 'Laporan Cheklis kendaraan OPS RPL'
})

useHead(() => ({
  title: 'Laporan Cheklis kendaraan OPS RPL - Laporan - TAG',
}))
...
const canPrint = userSession.checkPermission('ChecklisCitGuard', 'PrintLaporanRpl')
...
const onSubmit = async () => {
  ...
  try {
    ...
    //   method: 'GET',
    // })
    const response = await $fetch(`LaporanGuard/PrintLaporanRpl`, {
      params: {
        startDate: awal,
        endDate: akhir,
        cabang: lokasi.value,
                  ...
                  <div class="form-body">
                    ...
                    <div class="form-fieldset">
                      <div class="fieldset-heading">
                        <h4>RPL</h4>
                        <p>Laporan cheklis kendaraan RPL</p>
                      </div>
