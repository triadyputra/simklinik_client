...
onMounted(() => {
  pageTitle.value = 'View Cheklis Kendaraan RPL'
})

useHead(() => ({
  title: 'View Cheklis Kendaraan RPL - Guard - TAG',
}))
...
const canPrint = userSession.checkPermission('ChecklisRplGuard', 'PrintPdfRpl')
...
const paramId = route.params.formcheklisrpl
...
async function fetchEditData() {
  ...
  try {
    const response = await $fetch(`ChecklisRplGuard/GetDetailCheklisRpl?order=${paramId}`)
    if (response) {
      ...
      if (code != '200') {
        notyf.error(message)
        router.push('/guard/cheklis-kendaraan/rpl')
        return
      }
      ...
      kartubensin.value = resData.kartubensin
...
const onSubmit = async () => {
  ...
  try {
    ...
    const response = await $fetch(`ChecklisRplGuard/PrintPdfRpl`, {
      method: 'POST',
      body: payload,
    })
    ...
    <div class="form-outer">
      ...
      >
        <div class="form-header-inner">
          <div class="left">
            <h3>View Cheklis Kendaraan RPL</h3>
          </div>
          <div class="right">
            <div class="buttons">
              <VButton
        ...
        >
          ...
          <div class="form-section is-grey">
            ...
            <div class="left">
              ...
              <div v-if="kartubensin === 'Tidak Ada'" class="column is-12">
                <VField>
                  <VLabel>Keterangan</VLabel>
                  <VControl icon="fas fa-handshake">
                    <VInput
