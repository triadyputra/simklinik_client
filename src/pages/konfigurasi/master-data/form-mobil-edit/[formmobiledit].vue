...
const paramId = route.params.formmobiledit
...
async function fetchEditData() {
  ...
  try {
    const response = await $fetch(`MasterMobil/${paramId}`)
    if (response) {
      ...
      body.value = resData.body
      warna.value = resData.warna
      type.value = resData.type
      kduser.value = resData.kduser
      kdlokasi.value = resData.kdlokasi
      rental.value = resData.rental
      vendor.value = resData.vendor
      tahun.value = resData.tahun
      tglstnk.value = resData.tglstnk
      tglpajak.value = resData.tglpajak
      tglawalsewa.value = resData.tglawalsewa
      tglakhirsewa.value = resData.tglakhirsewa
      harga.value = resData.harga
      ppn.value = resData.ppn
      // nilaippn.value = resData.nilaippn
      // total.value = resData.total
      foglamp.value = resData.foglamp
      foglampket.value = resData.foglampket
      gps.value = resData.gps
      gpsket.value = resData.gpsket
            ...
            >
              <template #avatar>
                <img
                  v-if="!isUploading"
                  class="avatar"
                  :src="Photo ? Photo : '/images/avatars/box-truck.png'"
                  alt=""
