...
const goToEdit = (noRm: string) => {
  ...
  router.push(`/konfigurasi/akun/form-pengguna-edit/${noRm}`)
}
    ...
    <div class="datatable-toolbar">
      ...
      <VButtons>
        <VButton
          ...
          icon="fas fa-plus"
          elevated
          to="/konfigurasi/akun/form-pengguna-add"
        >
          Tambah
        </VButton>
      </VButtons>
            ...
            >
              <td>
                <div class="flex-media">
                  <VAvatar
                    :picture="user.Photo ?? '/images/avatars/role_4.png' "
                    alt="Avatar"
                  />
                  <div class="meta">
                    <h3>{{ user.FullName }}</h3>
              ...
              <td>
                <div class="tags">
                  <VTag
                    v-if="user.Active !== null && user.Active !== undefined"
                    rounded
                    :color="user.Active ? 'primary' : 'danger'"
                    elevated
                  >
                    {{ user.Active == true ? 'Aktive' : 'Non Active' }}
                  </VTag>
                </div>
              </td>
