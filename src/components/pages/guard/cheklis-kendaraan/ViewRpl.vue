...
const canView = userSession.checkPermission('ChecklisRplGuard', 'GetListCheklisRpl')
const canEdit = userSession.checkPermission('ChecklisRplGuard', 'GetDetailCheklisRpl')
...
async function fetchData() {
  try {
    ...
    const resData = await $fetch(`ChecklisRplGuard/GetListCheklisRpl`, {
      params: {
...
const goToEdit = (noRm: string) => {
  ...
  router.push(`/guard/cheklis-kendaraan/form-cheklis-rpl/${noRm}`)
}
